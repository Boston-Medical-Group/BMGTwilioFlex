...
class LanguageUtil {
    getLanguageStrings = async (language : string) => {
        console.debug('Getting template strings for language:', language);
        const fetchUrl = `${process.env.FLEX_APP_TWILIO_SERVERLESS_DOMAIN}/localization/getStrings`;
        const filePath = "/localization/" + language + ".json";
        const fetchBody = {
